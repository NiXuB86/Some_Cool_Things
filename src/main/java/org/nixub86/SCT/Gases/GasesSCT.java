...
public class GasesSCT {
	public static final GasType gasTypeNeurotoxin = new GasTypeNeurotoxin(true, 8, "Neurotoxin", 0x6F3F2F7F, 3, 4, Combustibility.NONE).setEffectRate(EffectType.BLINDNESS, 1).setEffectRate(EffectType.SUFFOCATION, 2).setEffectRate(EffectType.SLOWNESS, 16);
