...
public class ChunkProvaiderOnMir implements IChunkProvider {
    ...
    public ChunkProvaiderOnMir(World p_i2006_1_, long p_i2006_2_, boolean p_i2006_4_)
    {
    ...
    private void func_147423_a(int p_147423_1_, int p_147423_2_, int p_147423_3_)
    {
        ...
        this.field_147428_e = this.field_147431_j.generateNoiseOctaves(this.field_147428_e, p_147423_1_, p_147423_2_, p_147423_3_, 5, 33, 5, 5000D, 2000D, 5000D);
        this.field_147425_f = this.field_147432_k.generateNoiseOctaves(this.field_147425_f, p_147423_1_, p_147423_2_, p_147423_3_, 5, 33, 5, 50D, 684.412D, 50D);
        boolean flag1 = false;
        boolean flag = false;
        int l = 0;
        int i1 = 0;
