...
import org.nixub86.SCT.Utils.Network.AbstractMessage.AbstractServerMessage;
...
public class OpenGuiMessage extends AbstractServerMessage<OpenGuiMessage>
{
	...
	public void process(EntityPlayer player, Side side) {
		...
		player.openGui(SCT.instance, this.id, player.worldObj, (int) player.posX, (int) player.posY, (int) player.posZ);
	}
